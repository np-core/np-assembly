...
include { AssemblyGenotype as IlluminaGenotype } from './modules/genotype' addParams( tag: 'illumina' )
include { AssemblyGenotype as HybridGenotype } from './modules/genotype' addParams( tag: 'hybrid' )
include { AssemblyGenotype as MedakaGenotype } from './modules/genotype' addParams( tag: 'ont' )
include { AssemblyGenotype as UnicyclerGenotype } from './modules/genotype' addParams( tag: 'unicycler' )
